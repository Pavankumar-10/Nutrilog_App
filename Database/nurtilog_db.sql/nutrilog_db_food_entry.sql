...
CREATE TABLE `food_entry` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `food_entry_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
INSERT INTO `food_entry` VALUES (6,4,'Lassi',90.00,3.50,12.00,2.00,'Breakfast','2026-07-12'),(7,1,'Paneer',265.00,18.00,2.00,20.00,'Lunch','2026-07-13');
